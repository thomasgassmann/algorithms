...
public class AugmentedBinarySearchTreeNode {
    public AugmentedBinarySearchTreeNode(int key, AugmentedBinarySearchTreeNode parent, AugmentedBinarySearchTreeNode left, AugmentedBinarySearchTreeNode right, int size) {
        this.key = key;
        this.left = left;
        this.right = right;
        this.parent = parent;
    ...
    public AugmentedBinarySearchTreeNode parent;
    public int key;
    public int balance;
    public AugmentedBinarySearchTreeNode left;
    public AugmentedBinarySearchTreeNode right;
    public int size;
